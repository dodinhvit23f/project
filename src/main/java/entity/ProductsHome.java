...
public class ProductsHome {
	...
	public Products findById(java.lang.Integer id) {
		...
		try {
			Products instance = (Products) sessionFactory.getCurrentSession().get("entity.Products", id);
			if (instance == null) {
	...
	public List findByExample(Products instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("entity.Products")
