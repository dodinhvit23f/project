...
public class MembersHome {
	...
	public Members findById(java.lang.Integer id) {
		...
		try {
			Members instance = (Members) sessionFactory.getCurrentSession().get("entity.Members", id);
			if (instance == null) {
	...
	public List findByExample(Members instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("entity.Members")
